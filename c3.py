...
def generate_article(keyword, writing_style, institution, audience, word_count):
    ...
    response = openai.ChatCompletion.create(
        ...
        messages=[
                ...
                {"role": "user", "content": "The email should be " + ("casual" if writing_style == "Purple: Casual" else writing_style)},
...
writing_style = st.selectbox("Select writing style:", ["Purple: Casual", "Informative", "Witty"])
